...
# -----------------------------------------------------------
ndvi_rasters = {
    i: [f'{year}_{season}', f'data2/NDVI/seasons/Abergavenny_NDVI_{year}_{season}_harm_cog.tif']
...
s1_rasters = {
    i: [f'{year}_{season}', f'data2/NDVI/seasons/Abergavenny_S1_{year}_{season}_harm_cog.tif']
    for i, (year, season) in enumerate(
        ( (year, season) for year in range(2017, 2026) for season in ["Spring", "Summer", "Autumn", "Winter"] )
    )
}
